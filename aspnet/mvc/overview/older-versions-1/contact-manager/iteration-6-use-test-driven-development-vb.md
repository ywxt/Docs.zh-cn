...
**代码清单 1-Controllers\GroupControllerTest.vb**
...
**代码清单 2-Controllers\GroupController.vb**
...
**代码清单 6-Controllers\GroupControllerTest.vb**
...
**代码清单 8-Controllers\GroupController.vb**
...
**代码清单 11-Controllers\FakeContactManagerRepository.vb**
...
**图 05**： 更新数据库中的实体框架模型 ([单击以查看实际尺寸的图像](iteration-6-use-test-driven-development-vb/_static/image10.png))
...
**图 06**： 显示组和联系人实体设计器 ([单击以查看实际尺寸的图像](iteration-6-use-test-driven-development-vb/_static/image12.png))
...
**代码清单 14-Models\IContactManagerRepository.vb**
...
**代码清单 13-Models\EntityContactManagerRepository.vb**
...
**图 08**: 请联系索引视图 ([单击以查看实际尺寸的图像](iteration-6-use-test-driven-development-vb/_static/image16.png))
