...
**图 1**： 文本文件包含的最后一个日期和时间访问过书籍评论 ([单击以查看实际尺寸的图像](core-differences-between-iis-and-the-asp-net-development-server-cs/_static/image3.png))
...
**图 2**: 默认计算机帐户由 IIS 不会不有权写入到文件系统 ([单击以查看实际尺寸的图像](core-differences-between-iis-and-the-asp-net-development-server-cs/_static/image6.png))
...
**图 3**： 未经授权的用户会自动重定向到登录页 ([单击以查看实际尺寸的图像](core-differences-between-iis-and-the-asp-net-development-server-cs/_static/image9.png))
...
**图 4**： 匿名用户可以下载专用 PDF 文件的输入直接 URL 到文件 ([单击以查看实际尺寸的图像](core-differences-between-iis-and-the-asp-net-development-server-cs/_static/image12.png))
