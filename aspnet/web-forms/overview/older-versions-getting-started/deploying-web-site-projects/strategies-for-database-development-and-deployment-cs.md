...
ms.locfileid: "41833713"
---
<a name="strategies-for-database-development-and-deployment-c"></a>数据库开发和部署 (C#) 策略
====================
...
**图 1**： 比较开发和生产数据库 ([单击以查看实际尺寸的图像](strategies-for-database-development-and-deployment-cs/_static/image3.jpg))
...
**图 2**: SQL 比较列出了开发之间的差异和生产数据库 ([单击以查看实际尺寸的图像](strategies-for-database-development-and-deployment-cs/_static/image6.jpg))
...
**图 3**： 使用同步向导来同步数据库架构 ([单击以查看实际尺寸的图像](strategies-for-database-development-and-deployment-cs/_static/image9.jpg))
