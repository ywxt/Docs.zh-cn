...
**图 1**： 配置 SQL server 选择的应用程序服务 ([单击以查看实际尺寸的图像](configuring-a-website-that-uses-application-services-vb/_static/image3.jpg))
...
**图 2**： 提供的工具与您的数据库 s 连接信息 ([单击以查看实际尺寸的图像](configuring-a-website-that-uses-application-services-vb/_static/image6.jpg))
...
**图 4**： 确认数据库对象已添加到生产数据库 ([单击以查看实际尺寸的图像](configuring-a-website-that-uses-application-services-vb/_static/image12.jpg))
