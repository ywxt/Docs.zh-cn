...
**图 01**： 在母版页和内容页面的控件层次结构是融合在一起的 PreInit 阶段 ([单击以查看实际尺寸的图像](specifying-the-master-page-programmatically-vb/_static/image3.png))
...
**图 04**： 我们内容页面现在可以使用新的外观 ([单击以查看实际尺寸的图像](specifying-the-master-page-programmatically-vb/_static/image12.png))
...
**图 05**： 将新的内容页面添加到网站 ([单击以查看实际尺寸的图像](specifying-the-master-page-programmatically-vb/_static/image15.png))
...
**图 06**： 显示使用内容页都`Site.master`母版页 ([单击以查看实际尺寸的图像](specifying-the-master-page-programmatically-vb/_static/image18.png))
...
**图 07**： 内容页面会显示使用现在`Alternate.master`母版页 ([单击以查看实际尺寸的图像](specifying-the-master-page-programmatically-vb/_static/image21.png))
