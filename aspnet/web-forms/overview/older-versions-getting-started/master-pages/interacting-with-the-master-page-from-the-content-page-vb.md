...
**图 03**： 返回五种最最近添加的产品 ([单击以查看实际尺寸的图像](interacting-with-the-master-page-from-the-content-page-vb/_static/image9.png))
...
**图 04**: GridView 显示五种最最近添加的产品 ([单击以查看实际尺寸的图像](interacting-with-the-master-page-from-the-content-page-vb/_static/image12.png))
...
**图 06**： 向数据库添加一个新的产品 ([单击以查看实际尺寸的图像](interacting-with-the-master-page-from-the-content-page-vb/_static/image18.png))
...
**图 07**: IntelliSense 显示了我们的主页面的公共属性和方法 ([单击以查看实际尺寸的图像](interacting-with-the-master-page-from-the-content-page-vb/_static/image21.png))
...
**图 08**： 在母版页的标签和 GridView 显示 Just-Added 产品 ([单击以查看实际尺寸的图像](interacting-with-the-master-page-from-the-content-page-vb/_static/image24.png))
