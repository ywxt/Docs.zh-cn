...
声明性的标记中的第一行是[`@Master`指令](https://msdn.microsoft.com/library/ms228176.aspx)。 `@Master`指令是类似于[`@Page`指令](https://msdn.microsoft.com/library/ydy4x04a.aspx)在 ASP.NET 页中显示。 它定义的服务器端语言 (C#) 和信息的位置和母版页的代码隐藏类的继承。
