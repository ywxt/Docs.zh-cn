...
<strong>图 01</strong>: www.asp.net 网站采用一致的外观和感觉跨所有页面 ([单击以查看实际尺寸的图像](creating-a-site-wide-layout-using-master-pages-cs/_static/image3.png))
...
**图 03**: 请求的页面的标记融合到母版页 ([单击以查看实际尺寸的图像](creating-a-site-wide-layout-using-master-pages-cs/_static/image7.png))
...
**图 06**: 母版页的顶部、 左侧和底部部分定义标记 ([单击以查看实际尺寸的图像](creating-a-site-wide-layout-using-master-pages-cs/_static/image16.png))
...
**图 09**: 内容页面的设计视图显示的两个特定于页面的和主页面内容 ([单击以查看实际尺寸的图像](creating-a-site-wide-layout-using-master-pages-cs/_static/image25.png))
...
**图 11**: 对母版页进行的更改反映时查看的内容页 ([单击以查看实际尺寸的图像](creating-a-site-wide-layout-using-master-pages-cs/_static/image31.png))
