...
**图 03**: AJAX 控件工具包将出现在工具箱 ([单击以查看实际尺寸的图像](get-started-with-the-ajax-control-toolkit-vb/_static/image6.png))
...
**图 04**： 添加一个新选项卡 ([单击以查看实际尺寸的图像](get-started-with-the-ajax-control-toolkit-vb/_static/image8.png))
