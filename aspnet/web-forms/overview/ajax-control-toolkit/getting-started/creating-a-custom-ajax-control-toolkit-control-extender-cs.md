...
---
<a name="creating-a-custom-ajax-control-toolkit-control-extender-c"></a>创建自定义 AJAX 控件工具包扩展程序控件 (C#)
====================
...
**图 01**： 与网站和类的类库项目的解决方案 ([单击以查看实际尺寸的图像](creating-a-custom-ajax-control-toolkit-control-extender-cs/_static/image9.png))
...
**图 02**： 与所需的引用引用文件夹 ([单击以查看实际尺寸的图像](creating-a-custom-ajax-control-toolkit-control-extender-cs/_static/image12.png))
...
**图 04**： 在工具箱中 DisabledButton ([单击以查看实际尺寸的图像](creating-a-custom-ajax-control-toolkit-control-extender-cs/_static/image18.png))
...
**图 05**： 在扩展器向导对话框 ([单击以查看实际尺寸的图像](creating-a-custom-ajax-control-toolkit-control-extender-cs/_static/image21.png))
