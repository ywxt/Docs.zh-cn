...
**图 01**： 从工具箱中选择组合框控件 ([单击以查看实际尺寸的图像](how-do-i-use-the-combobox-control-vb/_static/image2.png))
...
**图 02**： 从项的静态列表中选择 ([单击以查看实际尺寸的图像](how-do-i-use-the-combobox-control-vb/_static/image4.png))
...
**图 04**： 显示选定的项 ([单击以查看实际尺寸的图像](how-do-i-use-the-combobox-control-vb/_static/image8.png))
...
**图 07**： 显示电影列表 ([单击以查看实际尺寸的图像](how-do-i-use-the-combobox-control-vb/_static/image14.png))
...
**图 08**: 组合框使建议 ([单击以查看实际尺寸的图像](how-do-i-use-the-combobox-control-vb/_static/image16.png))
...
**图 09**： 组合框将匹配的文本追加 ([单击以查看实际尺寸的图像](how-do-i-use-the-combobox-control-vb/_static/image18.png))
...
**图 10**: 组合框会建议，并追加 ([单击以查看实际尺寸的图像](how-do-i-use-the-combobox-control-vb/_static/image20.png))
