...
## <a name="adding-order-tracking"></a><span data-ttu-id="a4e35-127">添加顺序跟踪</span><span class="sxs-lookup"><span data-stu-id="a4e35-127">Adding Order Tracking</span></span>
...
10. <span data-ttu-id="a4e35-201">单击**是**将证书安装到本地主机。</span><span class="sxs-lookup"><span data-stu-id="a4e35-201">Click **Yes** to install the certificate to your localhost.</span></span>   
 ...
 <span data-ttu-id="a4e35-203">将显示浏览器窗口。</span><span class="sxs-lookup"><span data-stu-id="a4e35-203">The browser window will be displayed.</span></span>
...
13. <span data-ttu-id="a4e35-244">你还必须更新**Microsoft.Owin** 3.0.0 版的 NuGet 程序包。</span><span class="sxs-lookup"><span data-stu-id="a4e35-244">You must also update the **Microsoft.Owin** NuGet package to version 3.0.0.</span></span>   
    ...
    <span data-ttu-id="a4e35-246">从**管理 NuGet 包**窗口中，找到并更新**Microsoft.Owin** 3.0.0 版的包。</span><span class="sxs-lookup"><span data-stu-id="a4e35-246">From the **Manage NuGet Packages** window, find and update the **Microsoft.Owin** package to version 3.0.0.</span></span>
...
1. <span data-ttu-id="a4e35-279">在*帐户*文件夹中，打开代码隐藏文件命名为*Register.aspx.cs*。</span><span class="sxs-lookup"><span data-stu-id="a4e35-279">In the *Account* folder, open the code-behind file named *Register.aspx.cs*.</span></span>
...
1. <span data-ttu-id="a4e35-294">打开*Web.config*在项目的根目录的文件。</span><span class="sxs-lookup"><span data-stu-id="a4e35-294">Open the *Web.config* file at the root of the project.</span></span>
...
2. <span data-ttu-id="a4e35-423">现有的标记替换为以下代码：</span><span class="sxs-lookup"><span data-stu-id="a4e35-423">Replace the existing markup with the following:</span></span>   

    [!code-aspx[Main](checkout-and-payment-with-paypal/samples/sample24.aspx)]

### <a name="handle-purchase-errors"></a><span data-ttu-id="a4e35-424">处理购买错误</span><span class="sxs-lookup"><span data-stu-id="a4e35-424">Handle Purchase Errors</span></span>

<span data-ttu-id="a4e35-425">在购买过程中的错误将由*CheckoutError.aspx*页。</span><span class="sxs-lookup"><span data-stu-id="a4e35-425">Errors during the purchase process will be handled by the *CheckoutError.aspx* page.</span></span> <span data-ttu-id="a4e35-426">代码隐藏*CheckoutStart.aspx*页上， *CheckoutReview.aspx*页上，与*CheckoutComplete.aspx*页面将每个重定向到*CheckoutError.aspx*页上，如果发生错误。</span><span class="sxs-lookup"><span data-stu-id="a4e35-426">The code-behind of the *CheckoutStart.aspx* page, the *CheckoutReview.aspx* page, and the *CheckoutComplete.aspx* page will each redirect to the *CheckoutError.aspx* page if an error occurs.</span></span>

1. <span data-ttu-id="a4e35-427">打开名为的页*CheckoutError.aspx*中*签出*文件夹。</span><span class="sxs-lookup"><span data-stu-id="a4e35-427">Open the page named *CheckoutError.aspx* in the *Checkout* folder.</span></span>
2. <span data-ttu-id="a4e35-428">现有的标记替换为以下代码：</span><span class="sxs-lookup"><span data-stu-id="a4e35-428">Replace the existing markup with the following:</span></span>   

    [!code-aspx[Main](checkout-and-payment-with-paypal/samples/sample25.aspx)]

<span data-ttu-id="a4e35-429">*CheckoutError.aspx*在结帐过程中发生错误时，页将显示的错误详细信息。</span><span class="sxs-lookup"><span data-stu-id="a4e35-429">The *CheckoutError.aspx* page is displayed with the error details when an error occurs during the checkout process.</span></span>

## <a name="running-the-application"></a><span data-ttu-id="a4e35-430">运行应用程序</span><span class="sxs-lookup"><span data-stu-id="a4e35-430">Running the Application</span></span>

<span data-ttu-id="a4e35-431">运行应用程序以了解如何购买产品。</span><span class="sxs-lookup"><span data-stu-id="a4e35-431">Run the application to see how to purchase products.</span></span> <span data-ttu-id="a4e35-432">请注意，你会在中运行 PayPal 测试环境。</span><span class="sxs-lookup"><span data-stu-id="a4e35-432">Note that you will be running in the PayPal testing environment.</span></span> <span data-ttu-id="a4e35-433">要不交换的任何实际的资金。</span><span class="sxs-lookup"><span data-stu-id="a4e35-433">No actual money is being exchanged.</span></span>

1. <span data-ttu-id="a4e35-434">请确保所有在 Visual Studio 中保存你的文件。</span><span class="sxs-lookup"><span data-stu-id="a4e35-434">Make sure all your files are saved in Visual Studio.</span></span>
2. <span data-ttu-id="a4e35-435">打开 Web 浏览器并导航到[ https://developer.paypal.com ](https://developer.paypal.com/)。</span><span class="sxs-lookup"><span data-stu-id="a4e35-435">Open a Web browser and navigate to [https://developer.paypal.com](https://developer.paypal.com/).</span></span>
3. <span data-ttu-id="a4e35-436">使用你此前在本教程中创建的 PayPal 开发人员帐户登录。</span><span class="sxs-lookup"><span data-stu-id="a4e35-436">Login with your PayPal developer account that you created earlier in this tutorial.</span></span>  
   <span data-ttu-id="a4e35-437">对于 PayPal 的开发人员沙盒，你需要在登录[ https://developer.paypal.com ](https://developer.paypal.com/)测试 express 签出。</span><span class="sxs-lookup"><span data-stu-id="a4e35-437">For PayPal's developer sandbox, you need to be logged in at [https://developer.paypal.com](https://developer.paypal.com/) to test express checkout.</span></span> <span data-ttu-id="a4e35-438">这仅适用于测试，不适用于 PayPal 的实时环境 PayPal 的沙盒。</span><span class="sxs-lookup"><span data-stu-id="a4e35-438">This only applies to PayPal's sandbox testing, not to PayPal's live environment.</span></span>
4. <span data-ttu-id="a4e35-439">在 Visual Studio 中，按**F5**运行 Wingtip Toys 示例应用程序。</span><span class="sxs-lookup"><span data-stu-id="a4e35-439">In Visual Studio, press **F5** to run the Wingtip Toys sample application.</span></span>  
   <span data-ttu-id="a4e35-440">浏览器将重新生成数据库后，将打开并显示*Default.aspx*页。</span><span class="sxs-lookup"><span data-stu-id="a4e35-440">After the database rebuilds, the browser will open and show the *Default.aspx* page.</span></span>
5. <span data-ttu-id="a4e35-441">将三个不同的产品添加到购物车中，通过选择产品类别，如"汽车"，然后单击**将添加到购物车**旁边每个产品。</span><span class="sxs-lookup"><span data-stu-id="a4e35-441">Add three different products to the shopping cart by selecting the product category, such as "Cars" and then clicking **Add to Cart** next to each product.</span></span>  
   <span data-ttu-id="a4e35-442">购物车将显示所选的产品。</span><span class="sxs-lookup"><span data-stu-id="a4e35-442">The shopping cart will display the product you have selected.</span></span>
6. <span data-ttu-id="a4e35-443">单击**PayPal**签出的按钮。</span><span class="sxs-lookup"><span data-stu-id="a4e35-443">Click the **PayPal** button to checkout.</span></span> 

    ![签出和付款与 PayPal-购物车](checkout-and-payment-with-paypal/_static/image20.png)

   <span data-ttu-id="a4e35-445">签出将要求你具有用于 Wingtip Toys 示例应用程序的用户帐户。</span><span class="sxs-lookup"><span data-stu-id="a4e35-445">Checking out will require that you have a user account for the Wingtip Toys sample application.</span></span>
7. <span data-ttu-id="a4e35-446">单击**Google**在能够使用现有 gmail.com 电子邮件帐户进行登录页的右侧的链接。</span><span class="sxs-lookup"><span data-stu-id="a4e35-446">Click the **Google** link on the right of the page to log in with an existing gmail.com email account.</span></span>  
   <span data-ttu-id="a4e35-447">如果没有 gmail.com 帐户，则可以创建一个用于测试目的在[www.gmail.com](https://www.gmail.com/)。此外可以通过单击"注册"使用标准的本地帐户。</span><span class="sxs-lookup"><span data-stu-id="a4e35-447">If you do not have a gmail.com account, you can create one for testing purposes at [www.gmail.com](https://www.gmail.com/). You can also use a standard local account by clicking "Register".</span></span> 

    ![签出和付款与 PayPal-登录](checkout-and-payment-with-paypal/_static/image21.png)
8. <span data-ttu-id="a4e35-449">使用你 gmail 帐户和密码登录。</span><span class="sxs-lookup"><span data-stu-id="a4e35-449">Sign in with your gmail account and password.</span></span> 

    ![签出和付款与 PayPal-Gmail 登录](checkout-and-payment-with-paypal/_static/image22.png)
9. <span data-ttu-id="a4e35-451">单击**登录**按钮以将你的 gmail 帐户注册你 Wingtip Toys 示例应用程序的用户名。</span><span class="sxs-lookup"><span data-stu-id="a4e35-451">Click the **Log in** button to register your gmail account with your Wingtip Toys sample application user name.</span></span> 

    ![签出和付款与 PayPal-注册帐户](checkout-and-payment-with-paypal/_static/image23.png)
10. <span data-ttu-id="a4e35-453">在 PayPal 测试站点上，添加你**buyer**电子邮件地址以及你在本教程中，前面创建的密码，然后单击**Log In**按钮。</span><span class="sxs-lookup"><span data-stu-id="a4e35-453">On the PayPal test site, add your **buyer** email address and password that you created earlier in this tutorial, then click the **Log In** button.</span></span> 

    ![签出和付款与 PayPal-PayPal 登录](checkout-and-payment-with-paypal/_static/image24.png)
11. <span data-ttu-id="a4e35-455">同意 PayPal 策略并单击**同意并继续**按钮。</span><span class="sxs-lookup"><span data-stu-id="a4e35-455">Agree to the PayPal policy and click the **Agree and Continue** button.</span></span>  
    <span data-ttu-id="a4e35-456">请注意，此页才显示第一次使用此 PayPal 帐户。</span><span class="sxs-lookup"><span data-stu-id="a4e35-456">Note that this page is only displayed the first time you use this PayPal account.</span></span> <span data-ttu-id="a4e35-457">再次请注意，这是一个测试帐户，没有真正的现金进行交换。</span><span class="sxs-lookup"><span data-stu-id="a4e35-457">Again note that this is a test account, no real money is exchanged.</span></span> 

    ![签出和付款与 PayPal-PayPal 策略](checkout-and-payment-with-paypal/_static/image25.png)
12. <span data-ttu-id="a4e35-459">查看在测试环境审阅页面上，单击 PayPal 订单信息**继续**。</span><span class="sxs-lookup"><span data-stu-id="a4e35-459">Review the order information on the PayPal testing environment review page and click **Continue**.</span></span> 

    ![签出和付款与 PayPal-查看信息](checkout-and-payment-with-paypal/_static/image26.png)
13. <span data-ttu-id="a4e35-461">上*CheckoutReview.aspx*页上，验证订单量并查看生成的邮寄地址。</span><span class="sxs-lookup"><span data-stu-id="a4e35-461">On the *CheckoutReview.aspx* page, verify the order amount and view the generated shipping address.</span></span> <span data-ttu-id="a4e35-462">然后，单击**完整 Order**按钮。</span><span class="sxs-lookup"><span data-stu-id="a4e35-462">Then, click the **Complete Order** button.</span></span> 

    ![签出和付款与 PayPal-订单审核](checkout-and-payment-with-paypal/_static/image27.png)
14. <span data-ttu-id="a4e35-464">**CheckoutComplete.aspx**页显示带有付款事务 id。</span><span class="sxs-lookup"><span data-stu-id="a4e35-464">The **CheckoutComplete.aspx** page is displayed with a payment transaction ID.</span></span> 

    ![签出和与 PayPal-签出完整的付款](checkout-and-payment-with-paypal/_static/image28.png)

<a id="ReviewDBWebForms"></a>
## <a name="reviewing-the-database"></a><span data-ttu-id="a4e35-466">查看数据库</span><span class="sxs-lookup"><span data-stu-id="a4e35-466">Reviewing the Database</span></span>

<span data-ttu-id="a4e35-467">通过运行应用程序后查看 Wingtip Toys 示例应用程序数据库中更新后的数据，你可以看到应用程序成功记录购买产品。</span><span class="sxs-lookup"><span data-stu-id="a4e35-467">By reviewing the updated data in the Wingtip Toys sample application database after running the application, you can see that the application successfully recorded the purchase of the products.</span></span>

<span data-ttu-id="a4e35-468">你可以检查中包含的数据*Wingtiptoys.mdf*数据库文件使用**数据库资源管理器**窗口 (**服务器资源管理器**Visual Studio 窗口中的) 就像之前在本教程系列。</span><span class="sxs-lookup"><span data-stu-id="a4e35-468">You can inspect the data contained in the *Wingtiptoys.mdf* database file by using the **Database Explorer** window (**Server Explorer** window in Visual Studio) as you did earlier in this tutorial series.</span></span>

1. <span data-ttu-id="a4e35-469">如果它仍处于打开状态，请关闭浏览器窗口。</span><span class="sxs-lookup"><span data-stu-id="a4e35-469">Close the browser window if it is still open.</span></span>
2. <span data-ttu-id="a4e35-470">在 Visual Studio 中，选择**显示所有文件**顶部的图标**解决方案资源管理器**以便您可以展开**应用\_数据**文件夹。</span><span class="sxs-lookup"><span data-stu-id="a4e35-470">In Visual Studio, select the **Show All Files** icon at the top of **Solution Explorer** to allow you to expand the **App\_Data** folder.</span></span>
3. <span data-ttu-id="a4e35-471">展开**应用\_数据**文件夹。</span><span class="sxs-lookup"><span data-stu-id="a4e35-471">Expand the **App\_Data** folder.</span></span>  
 <span data-ttu-id="a4e35-472">你可能需要选择**显示所有文件**文件夹图标。</span><span class="sxs-lookup"><span data-stu-id="a4e35-472">You may need to select the **Show All Files** icon for the folder.</span></span>
4. <span data-ttu-id="a4e35-473">右键单击*Wingtiptoys.mdf*数据库文件并选择**打开**。</span><span class="sxs-lookup"><span data-stu-id="a4e35-473">Right-click the *Wingtiptoys.mdf* database file and select **Open**.</span></span>  
    <span data-ttu-id="a4e35-474">**服务器资源管理器**显示。</span><span class="sxs-lookup"><span data-stu-id="a4e35-474">**Server Explorer** is displayed.</span></span>
5. <span data-ttu-id="a4e35-475">展开**表**文件夹。</span><span class="sxs-lookup"><span data-stu-id="a4e35-475">Expand the **Tables** folder.</span></span>
6. <span data-ttu-id="a4e35-476">右键单击**订单**表，然后选择**显示表数据**。</span><span class="sxs-lookup"><span data-stu-id="a4e35-476">Right-click the **Orders**table and select **Show Table Data**.</span></span>  
 <span data-ttu-id="a4e35-477">**订单**显示表。</span><span class="sxs-lookup"><span data-stu-id="a4e35-477">The **Orders** table is displayed.</span></span>
7. <span data-ttu-id="a4e35-478">查看**PaymentTransactionID**列以确认成功的事务。</span><span class="sxs-lookup"><span data-stu-id="a4e35-478">Review the **PaymentTransactionID** column to confirm successful transactions.</span></span> 

    ![签出和 PayPal-查看数据库使用的付款](checkout-and-payment-with-paypal/_static/image29.png)
8. <span data-ttu-id="a4e35-480">关闭**订单**表窗口。</span><span class="sxs-lookup"><span data-stu-id="a4e35-480">Close the **Orders** table window.</span></span>
9. <span data-ttu-id="a4e35-481">在服务器资源管理器，右键单击**OrderDetails**表，然后选择**显示表数据**。</span><span class="sxs-lookup"><span data-stu-id="a4e35-481">In the Server Explorer, right-click the **OrderDetails** table and select **Show Table Data**.</span></span>
10. <span data-ttu-id="a4e35-482">查看`OrderId`和`Username`中值**OrderDetails**表。</span><span class="sxs-lookup"><span data-stu-id="a4e35-482">Review the `OrderId` and `Username` values in the **OrderDetails** table.</span></span> <span data-ttu-id="a4e35-483">请注意，这些值匹配`OrderId`和`Username`中包含的值**订单**表。</span><span class="sxs-lookup"><span data-stu-id="a4e35-483">Note that these values match the `OrderId` and `Username` values included in the **Orders** table.</span></span>
11. <span data-ttu-id="a4e35-484">关闭**OrderDetails**表窗口。</span><span class="sxs-lookup"><span data-stu-id="a4e35-484">Close the **OrderDetails** table window.</span></span>
12. <span data-ttu-id="a4e35-485">右键单击 Wingtip Toys 数据库文件 (*Wingtiptoys.mdf*)，然后选择**关闭连接**。</span><span class="sxs-lookup"><span data-stu-id="a4e35-485">Right-click the Wingtip Toys database file (*Wingtiptoys.mdf*) and select **Close Connection**.</span></span>
13. <span data-ttu-id="a4e35-486">如果看不到**解决方案资源管理器**窗口中，单击**解决方案资源管理器**底部**服务器资源管理器**窗口以显示**解决方案资源管理器**试。</span><span class="sxs-lookup"><span data-stu-id="a4e35-486">If you do not see the **Solution Explorer** window, click **Solution Explorer** at the bottom of the **Server Explorer** window to show the **Solution Explorer** again.</span></span>

## <a name="summary"></a><span data-ttu-id="a4e35-487">总结</span><span class="sxs-lookup"><span data-stu-id="a4e35-487">Summary</span></span>

<span data-ttu-id="a4e35-488">在本教程中你添加了订单和订单详细信息架构跟踪购买产品。</span><span class="sxs-lookup"><span data-stu-id="a4e35-488">In this tutorial you added order and order detail schemas to track the purchase of products.</span></span> <span data-ttu-id="a4e35-489">你还可以集成到 Wingtip Toys 示例应用程序 PayPal 功能。</span><span class="sxs-lookup"><span data-stu-id="a4e35-489">You also integrated PayPal functionality into the Wingtip Toys sample application.</span></span>

## <a name="additional-resources"></a><span data-ttu-id="a4e35-490">其他资源</span><span class="sxs-lookup"><span data-stu-id="a4e35-490">Additional Resources</span></span>

<span data-ttu-id="a4e35-491">[ASP.NET 配置概述](https://msdn.microsoft.com/library/ms178683(v=vs.100).aspx)</span><span class="sxs-lookup"><span data-stu-id="a4e35-491">[ASP.NET Configuration Overview](https://msdn.microsoft.com/library/ms178683(v=vs.100).aspx)</span></span>  
[<span data-ttu-id="a4e35-492">将包含成员资格、 OAuth 和 SQL 数据库的安全的 ASP.NET Web 窗体应用程序部署到 Azure App Service</span><span class="sxs-lookup"><span data-stu-id="a4e35-492">Deploy a Secure ASP.NET Web Forms App with Membership, OAuth, and SQL Database to Azure App Service</span></span>](https://azure.microsoft.com/documentation/articles/web-sites-dotnet-deploy-aspnet-webforms-app-membership-oauth-sql-database/)  
[<span data-ttu-id="a4e35-493">Microsoft Azure 的免费试用版</span><span class="sxs-lookup"><span data-stu-id="a4e35-493">Microsoft Azure - Free Trial</span></span>](https://azure.microsoft.com/pricing/free-trial/)

## <a name="disclaimer"></a><span data-ttu-id="a4e35-494">免责声明</span><span class="sxs-lookup"><span data-stu-id="a4e35-494">Disclaimer</span></span>

<span data-ttu-id="a4e35-495">本教程包含示例代码。</span><span class="sxs-lookup"><span data-stu-id="a4e35-495">This tutorial contains sample code.</span></span> <span data-ttu-id="a4e35-496">此类示例代码"按原样"提供，而无需任何形式的保证。</span><span class="sxs-lookup"><span data-stu-id="a4e35-496">Such sample code is provided "as is" without warranty of any kind.</span></span> <span data-ttu-id="a4e35-497">相应地，Microsoft 不保证准确性、 完整性或对示例代码质量。</span><span class="sxs-lookup"><span data-stu-id="a4e35-497">Accordingly, Microsoft does not guarantee the accuracy, integrity, or quality of the sample code.</span></span> <span data-ttu-id="a4e35-498">您同意在你自己的风险时使用的示例代码。</span><span class="sxs-lookup"><span data-stu-id="a4e35-498">You agree to use the sample code at your own risk.</span></span> <span data-ttu-id="a4e35-499">在任何情况下将 Microsoft 的应承担给你以任何方式内容，包括但不是限于任何错误或遗漏的任何示例代码、 内容，或任何丢失或损坏导致的任何示例代码使用产生任何任何的类型示例代码。</span><span class="sxs-lookup"><span data-stu-id="a4e35-499">Under no circumstances will Microsoft be liable to you in any way for any sample code, content, including but not limited to, any errors or omissions in any sample code, content, or any loss or damage of any kind incurred as a result of the use of any sample code.</span></span> <span data-ttu-id="a4e35-500">特此收到通知，特此同意赔偿，保存并保存 Microsoft 无害从和针对所有损失、 丢失、 受伤或的任何类型的包括但不限于，那些由 occasioned 或因你发布的材料的损坏的声明传输、 使用或依赖于包括但不是限于表示其中的视图。</span><span class="sxs-lookup"><span data-stu-id="a4e35-500">You are hereby notified and do hereby agree to indemnify, save and hold Microsoft harmless from and against any and all loss, claims of loss, injury or damage of any kind including, without limitation, those occasioned by or arising from material that you post, transmit, use or rely on including, but not limited to, the views expressed therein.</span></span>

> [!div class="step-by-step"]
> <span data-ttu-id="a4e35-501">[上一页](shopping-cart.md)
> [下一页](membership-and-administration.md)</span><span class="sxs-lookup"><span data-stu-id="a4e35-501">[Previous](shopping-cart.md)
