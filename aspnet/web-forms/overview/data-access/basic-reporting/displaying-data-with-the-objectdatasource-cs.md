...
**图 2**: ObjectDataSource 充当代理的 ([单击以查看实际尺寸的图像](displaying-data-with-the-objectdatasource-cs/_static/image4.png))
...
**图 4**： 指定使用该对象具有 ObjectDataSource 控件 ([单击以查看实际尺寸的图像](displaying-data-with-the-objectdatasource-cs/_static/image10.png))
...
**图 5**： 从选择选项卡中选择返回数据的方法 ([单击以查看实际尺寸的图像](displaying-data-with-the-objectdatasource-cs/_static/image13.png))
...
**图 6**: GridView 已添加到页上，然后绑定到对象数据源 ([单击以查看实际尺寸的图像](displaying-data-with-the-objectdatasource-cs/_static/image16.png))
...
**图 7**： 管理 GridView 的 BoundFields 通过编辑列对话框 ([单击以查看实际尺寸的图像](displaying-data-with-the-objectdatasource-cs/_static/image19.png))
...
**图 8**： 的 GridView BoundFields 已自定义 ([单击以查看实际尺寸的图像](displaying-data-with-the-objectdatasource-cs/_static/image22.png))
...
**图 13**： 添加到页面的 DetailsView 并将其绑定到对象数据源 ([单击以查看实际尺寸的图像](displaying-data-with-the-objectdatasource-cs/_static/image35.png))
...
**图 14**: DetailsView 显示一条记录 ([单击以查看实际尺寸的图像](displaying-data-with-the-objectdatasource-cs/_static/image38.png))
...
**图 15**： 在 DetailsView 控件中启用分页 ([单击以查看实际尺寸的图像](displaying-data-with-the-objectdatasource-cs/_static/image41.png))
...
**图 16**： 与已启用分页，DetailsView 允许用户查看的任何产品 ([单击以查看实际尺寸的图像](displaying-data-with-the-objectdatasource-cs/_static/image44.png))
...
**图 17**: 必须包括 FormView `ItemTemplate` ([单击以查看实际尺寸的图像](displaying-data-with-the-objectdatasource-cs/_static/image47.png))
...
**图 18**： 根据第一个产品 (Chai) 显示在自定义格式 ([单击以查看实际尺寸的图像](displaying-data-with-the-objectdatasource-cs/_static/image50.png))
