...
**图 3**： 在 GridView 中显示的产品列表 ([单击以查看实际尺寸的图像](creating-a-business-logic-layer-vb/_static/image5.png))
...
**图 4**: DataColumn 提供基本字段级验证 ([单击以查看实际尺寸的图像](creating-a-business-logic-layer-vb/_static/image8.png))
