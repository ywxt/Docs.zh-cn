...
**图 1**： 两个 Templatefield 用于自定义显示 ([单击以查看实际尺寸的图像](using-templatefields-in-the-detailsview-control-cs/_static/image3.png))
...
**图 3**： 根据产品的详细信息会显示使用 BoundFields 系列 ([单击以查看实际尺寸的图像](using-templatefields-in-the-detailsview-control-cs/_static/image9.png))
...
**图 4**： 将新 TemplateField 添加到 DetailsView 控件 ([单击以查看实际尺寸的图像](using-templatefields-in-the-detailsview-control-cs/_static/image12.png))
...
**图 5**： 将标签的绑定`Text`属性设置为`UnitPrice`数据字段 ([单击以查看实际尺寸的图像](using-templatefields-in-the-detailsview-control-cs/_static/image15.png))
...
**图 6**: 价格和库存 templatefield 进一步显示的价格 ([单击以查看实际尺寸的图像](using-templatefields-in-the-detailsview-control-cs/_static/image18.png))
...
**图 8**: 价格和库存信息会显示在单个行 ([单击以查看实际尺寸的图像](using-templatefields-in-the-detailsview-control-cs/_static/image24.png))
...
**图 10**: 是或否的值为现在 Discontinued 行中所示 ([单击以查看实际尺寸的图像](using-templatefields-in-the-detailsview-control-cs/_static/image30.png))
