...
**图 4**： 每个 GridView 行现在包括一个删除按钮 ([单击以查看实际尺寸的图像](inserting-updating-and-deleting-data-with-the-sqldatasource-cs/_static/image6.png))
...
**图 7**： 使用`Products`表中，返回`ProductID`， `ProductName`， `UnitPrice`，并且`Discontinued`列 ([单击以查看实际尺寸的图像](inserting-updating-and-deleting-data-with-the-sqldatasource-cs/_static/image10.png))
...
**图 9**: DetailsView s 默认编辑界面 ([单击以查看实际尺寸的图像](inserting-updating-and-deleting-data-with-the-sqldatasource-cs/_static/image12.png))
