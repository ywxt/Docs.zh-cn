...
ms.locfileid: "41830898"
---
<a name="querying-data-with-the-sqldatasource-control-vb"></a>使用 SqlDataSource 控件 (VB) 查询数据
====================
...
**图 11**： 根据 GridView 显示每个产品 s `ProductID`， `ProductName`，和`UnitPrice`值 ([单击以查看实际尺寸的图像](querying-data-with-the-sqldatasource-control-vb/_static/image17.gif))
...
**图 15**： 根据 GridView 显示了每个产品的 ID、 名称和关联的类别名称 ([单击以查看实际尺寸的图像](querying-data-with-the-sqldatasource-control-vb/_static/image23.gif))
