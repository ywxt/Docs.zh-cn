...
**图 1**： 从表或视图返回结果中选择列 ([单击以查看实际尺寸的图像](using-parameterized-queries-with-the-sqldatasource-vb/_static/image2.png))
...
**图 3**： 显示仅这些产品小于或等于 $25.00 ([单击以查看实际尺寸的图像](using-parameterized-queries-with-the-sqldatasource-vb/_static/image6.png))
...
**图 4**： 返回仅这些产品小于或等于参数值 ([单击以查看实际尺寸的图像](using-parameterized-queries-with-the-sqldatasource-vb/_static/image8.png))
...
**图 6**： 否记录是否显示时`MaxPrice`文本框中为空 ([单击以查看实际尺寸的图像](using-parameterized-queries-with-the-sqldatasource-vb/_static/image12.png))
...
**图 7**： 显示产品小于或等于花 5.00 美元 ([单击以查看实际尺寸的图像](using-parameterized-queries-with-the-sqldatasource-vb/_static/image14.png))
...
**图 8**： 现在的所有产品都都显示时`MaxPrice`文本框中为空 ([单击以查看实际尺寸的图像](using-parameterized-queries-with-the-sqldatasource-vb/_static/image16.png))
...
**图 10**： 选择`GetProductsByCategory`下拉列表中的存储过程 ([单击以查看实际尺寸的图像](using-parameterized-queries-with-the-sqldatasource-vb/_static/image20.png))
