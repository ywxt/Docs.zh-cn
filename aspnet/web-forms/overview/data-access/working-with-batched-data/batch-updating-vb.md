...
**图 1**： 在 GridView 中的每个行是可编辑 ([单击以查看实际尺寸的图像](batch-updating-vb/_static/image2.png))
...
**图 4**： 设置下拉列表列出了在更新、 插入和删除选项卡中为 （无） ([单击以查看实际尺寸的图像](batch-updating-vb/_static/image8.png))
...
**图 7**： 添加 CompareValidator，确保价格输入是一个非负货币值 ([单击以查看实际尺寸的图像](batch-updating-vb/_static/image12.png))
...
**图 13**： 每个 GridView 行是可编辑 ([单击以查看实际尺寸的图像](batch-updating-vb/_static/image22.png))
...
**图 16**: 页现在包含两个更新的产品按钮 ([单击以查看实际尺寸的图像](batch-updating-vb/_static/image24.png))
