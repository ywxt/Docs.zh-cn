...
**图 5**： 指示存储过程返回表格格式数据 ([单击以查看实际尺寸的图像](using-existing-stored-procedures-for-the-typed-dataset-s-tableadapters-cs/_static/image15.png))
...
**图 8**： 设置下拉列表列出了在更新、 插入和删除选项卡中为 （无） ([单击以查看实际尺寸的图像](using-existing-stored-procedures-for-the-typed-dataset-s-tableadapters-cs/_static/image24.png))
...
**图 12**： 显示在生成类别的产品 ([单击以查看实际尺寸的图像](using-existing-stored-procedures-for-the-typed-dataset-s-tableadapters-cs/_static/image36.png))
...
**图 13**： 具有编辑和删除按钮的 GridView 中显示每个类别 ([单击以查看实际尺寸的图像](using-existing-stored-procedures-for-the-typed-dataset-s-tableadapters-cs/_static/image39.png))
...
**图 14**： 不能删除现有产品的类别 ([单击以查看实际尺寸的图像](using-existing-stored-procedures-for-the-typed-dataset-s-tableadapters-cs/_static/image42.png))
