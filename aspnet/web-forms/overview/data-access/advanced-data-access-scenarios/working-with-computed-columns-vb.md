...
**图 6**： 运行 TableAdapter 的配置向导以更新 DataTable 的列 ([单击以查看实际尺寸的图像](working-with-computed-columns-vb/_static/image18.png))
...
**图 8**： 选择它返回行选项 ([单击以查看实际尺寸的图像](working-with-computed-columns-vb/_static/image24.png))
...
**图 12**： 在网格中列出每个供应商 ([单击以查看实际尺寸的图像](working-with-computed-columns-vb/_static/image36.png))
