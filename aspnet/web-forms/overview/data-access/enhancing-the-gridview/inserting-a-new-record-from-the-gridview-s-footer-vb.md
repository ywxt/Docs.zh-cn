...
ms.locfileid: "37828314"
---
<a name="inserting-a-new-record-from-the-gridviews-footer-vb"></a>从 GridView 页脚 (VB) 插入新记录
====================
...
**图 1**： 脚注行提供用于添加新产品的接口 ([单击以查看实际尺寸的图像](inserting-a-new-record-from-the-gridview-s-footer-vb/_static/image2.png))
...
**图 3**： 映射`AddProduct`方法的 ObjectDataSource s`Insert()`方法 ([单击以查看实际尺寸的图像](inserting-a-new-record-from-the-gridview-s-footer-vb/_static/image6.png))
...
**图 5**： 将已分页的 GridView 中显示所有产品数据字段 ([单击以查看实际尺寸的图像](inserting-a-new-record-from-the-gridview-s-footer-vb/_static/image10.png))
...
**图 6**： 为显示脚注行中，设置`ShowFooter`到`True`([单击以查看实际尺寸的图像](inserting-a-new-record-from-the-gridview-s-footer-vb/_static/image12.png))
...
**图 7**: 空的脚注行是显示上面分页界面控件 ([单击以查看实际尺寸的图像](inserting-a-new-record-from-the-gridview-s-footer-vb/_static/image14.png))
...
**图 12**: 添加按钮 s 回发是短 Circuited 如果插入界面中存在无效数据 ([单击以查看实际尺寸的图像](inserting-a-new-record-from-the-gridview-s-footer-vb/_static/image22.png))
