...
**图 1**： 当两个用户同时更新记录那里 s 潜力的一个用户的更改覆盖到对方的 ([单击以查看实际尺寸的图像](implementing-optimistic-concurrency-vb/_static/image3.png))
...
**图 2**: For Update 或 Delete succeed，原始值必须为等于当前的数据库值 ([单击以查看实际尺寸的图像](implementing-optimistic-concurrency-vb/_static/image6.png))
...
**图 5**： 使用从相同的 SQL 查询`Products`原始 DAL 中的 TableAdapter ([单击以查看实际尺寸的图像](implementing-optimistic-concurrency-vb/_static/image15.png))
...
**图 8**: 数据表和 TableAdapter 已添加到类型化数据集 ([单击以查看实际尺寸的图像](implementing-optimistic-concurrency-vb/_static/image24.png))
...
**图 9**： 将为该查询类型标记"`SELECT`返回的行"([单击以查看实际尺寸的图像](implementing-optimistic-concurrency-vb/_static/image27.png))
...
**图 14**： 在 GridView 中列出了产品 ([单击以查看实际尺寸的图像](implementing-optimistic-concurrency-vb/_static/image40.png))
...
**图 16**: ObjectDataSource 找不到具有它需要发送到输入参数的方法 ([单击以查看实际尺寸的图像](implementing-optimistic-concurrency-vb/_static/image46.png))
...
**图 19**: 用户 s 在并发冲突的人脸会丢失更新 ([单击以查看实际尺寸的图像](implementing-optimistic-concurrency-vb/_static/image55.png))
...
**图 20**： 在遇到并发冲突时取消删除用户 s ([单击以查看实际尺寸的图像](implementing-optimistic-concurrency-vb/_static/image58.png))
