...
**图 2**： 根据 FormView 显示信息有关单个产品 ([单击以查看实际尺寸的图像](adding-client-side-confirmation-when-deleting-vb/_static/image4.png))
...
**图 3**: 确认是现在显示时单击删除按钮 ([单击以查看实际尺寸的图像](adding-client-side-confirmation-when-deleting-vb/_static/image7.png))
...
**图 4**： 单击删除按钮的 GridView s 显示自定义确认对话框 ([单击以查看实际尺寸的图像](adding-client-side-confirmation-when-deleting-vb/_static/image10.png))
