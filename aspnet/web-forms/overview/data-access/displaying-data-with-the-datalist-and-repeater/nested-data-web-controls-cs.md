...
**图 1**： 列出每个类别，以及其产品，([单击以查看实际尺寸的图像](nested-data-web-controls-cs/_static/image3.png))
...
**图 4**： 每个类别的名称和描述列出，则用水平标尺分隔 ([单击以查看实际尺寸的图像](nested-data-web-controls-cs/_static/image12.png))
...
**图 5**: 外部 Repeater 列出了每个类别; 内部一个列出该类别的产品 ([单击以查看实际尺寸的图像](nested-data-web-controls-cs/_static/image15.png))
