...
**图 4**:`ProductsCL`类包括在业务对象下拉列表 ([单击以查看实际尺寸的图像](caching-data-in-the-architecture-vb/_static/image6.png))
...
**图 5**:`ProductsCL`的下拉列表中列出了类的方法 ([单击以查看实际尺寸的图像](caching-data-in-the-architecture-vb/_static/image9.png))
