...
**图 3**： 添加`Global.asax`为 s 的 Web 应用程序根目录的文件 ([单击以查看实际尺寸的图像](caching-data-at-application-startup-vb/_static/image5.png))
...
**图 7**： 在 GridView 中显示缓存供应商数据 ([单击以查看实际尺寸的图像](caching-data-at-application-startup-vb/_static/image17.png))
