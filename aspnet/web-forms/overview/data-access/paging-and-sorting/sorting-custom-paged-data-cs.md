...
**图 2**: 存储过程的结果显示在输出窗口 ([单击以查看实际尺寸的图像](sorting-custom-paged-data-cs/_static/image4.png))
...
**图 7**: 结果按单价 ([单击以查看实际尺寸的图像](sorting-custom-paged-data-cs/_static/image11.png))
...
**图 10**: 可以现在按结果进行排序供应商 ([单击以查看实际尺寸的图像](sorting-custom-paged-data-cs/_static/image16.png))
