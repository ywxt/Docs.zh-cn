...
**图 2**： 按类别排序数据的可排序的 GridView s ([单击以查看实际尺寸的图像](creating-a-customized-sorting-user-interface-cs/_static/image6.png))
...
**图 4**： 一种替代方式操作 GridView 的控件层次结构 ([单击以查看实际尺寸的图像](creating-a-customized-sorting-user-interface-cs/_static/image10.png))
...
**图 5**: 排序接口包括排序组标头时排序通过 BoundFields ([单击以查看实际尺寸的图像](creating-a-customized-sorting-user-interface-cs/_static/image13.png))
