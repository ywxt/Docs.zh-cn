...
**图 6**： 列出了每个产品 ([单击以查看实际尺寸的图像](paging-and-sorting-report-data-vb/_static/image8.png))
...
**图 7**： 选中启用分页复选框以添加分页支持 ([单击以查看实际尺寸的图像](paging-and-sorting-report-data-vb/_static/image11.png))
...
**图 8**： 一次使用已启用分页，显示记录的一个子集 ([单击以查看实际尺寸的图像](paging-and-sorting-report-data-vb/_static/image14.png))
...
**图 9**： 单击页码导致回发并显示相应记录子集 ([单击以查看实际尺寸的图像](paging-and-sorting-report-data-vb/_static/image17.png))
...
**图 11**: 用户将自动转到第六个页时选择页面 6 下拉列表项 ([单击以查看实际尺寸的图像](paging-and-sorting-report-data-vb/_static/image23.png))
...
**图 12**: 结果具有已按升序顺序单价 ([单击以查看实际尺寸的图像](paging-and-sorting-report-data-vb/_static/image26.png))
...
**图 15**： 单击的按钮进行排序的产品从最高到最少 ([单击以查看实际尺寸的图像](paging-and-sorting-report-data-vb/_static/image33.png))
