...
**图 1**： 可以修改完全可编辑的 DataList 中的每个项 ([单击以查看实际尺寸的图像](performing-batch-updates-vb/_static/image3.png))
...
**图 4**： 在更新选项卡中设置为 （无） 下拉列表 ([单击以查看实际尺寸的图像](performing-batch-updates-vb/_static/image12.png))
...
**图 6**： 两个更新所有按钮已都添加到页面 ([单击以查看实际尺寸的图像](performing-batch-updates-vb/_static/image18.png))
