...
**图 03**： 将主页面名为 Site.master 添加到网站 ([单击以查看实际尺寸的图像](an-overview-of-forms-authentication-vb/_static/image9.png))
...
**图 05**： 添加新 Default.aspx 页上选择选择主机页 ([单击以查看实际尺寸的图像](an-overview-of-forms-authentication-vb/_static/image15.png))
...
**图 07**： 如果你项目不会不尚未包括 Web.config，现在添加 ([单击以查看实际尺寸的图像](an-overview-of-forms-authentication-vb/_static/image21.png))
...
**图 08**： 添加新 ASP.NET 页名为 login.aspx 的情况 ([单击以查看实际尺寸的图像](an-overview-of-forms-authentication-vb/_static/image24.png))
...
**图 09**: 登录页包含两个文本框、 复选框、 按钮和标签 ([单击以查看实际尺寸的图像](an-overview-of-forms-authentication-vb/_static/image27.png))
...
**图 11**： 显示时访问以匿名方式、 日志中链接 ([单击以查看实际尺寸的图像](an-overview-of-forms-authentication-vb/_static/image33.png))
...
**图 12**： 经过身份验证的用户显示欢迎回来 ！ 消息 ([单击此项可查看原尺寸图像](an-overview-of-forms-authentication-vb/_static/image36.png))
...
首先，通过添加母版页中导航到名为 LoginContent ContentPlaceHolder &lt;div&gt;元素。 只需将 ContentPlaceHolder 控件从工具箱拖到源视图中，放置所得的标记正上方 TODO： 菜单将转到此处的文本。
...
**图 14**： 在工具箱中的 LoginView 控件 ([单击以查看实际尺寸的图像](an-overview-of-forms-authentication-vb/_static/image42.png))
...
**图 16**： 登录页会显示默认内容的母版页的 LoginContent ContentPlaceHolder ([单击以查看实际尺寸的图像](an-overview-of-forms-authentication-vb/_static/image48.png))
...
**图 17**： 登录页上隐藏默认 LoginContent ContentPlaceHolder 的标记 ([单击以查看实际尺寸的图像](an-overview-of-forms-authentication-vb/_static/image51.png))
...
**图 18**: Default.aspx 显示欢迎使用后退、 Jisun 沿与注销 LinkButton ([单击以查看实际尺寸的图像](an-overview-of-forms-authentication-vb/_static/image54.png))
...
**图 19**: Logout.aspx 显示欢迎使用，以及登录名 LinkButton stranger ([单击以查看实际尺寸的图像](an-overview-of-forms-authentication-vb/_static/image57.png))
