...
**图 1**: 经过身份验证用户时使用窗体身份验证和角色框架的 ASP.NET 管道事件 ([单击以查看实际尺寸的图像](role-based-authorization-cs/_static/image3.png))
...
**图 2**: 用户的角色的信息可以存储在 Cookie 中提高性能 ([单击以查看实际尺寸的图像](role-based-authorization-cs/_static/image6.png))
...
**图 4**： 只有管理员角色中的用户可以查看受保护页面 ([单击以查看实际尺寸的图像](role-based-authorization-cs/_static/image12.png))
...
**图 5**： 可以访问 Tito`UsersAndRoles.aspx`页因为他是管理员角色中 ([单击以查看实际尺寸的图像](role-based-authorization-cs/_static/image15.png))
...
**图 6**： 的 GridView 字段可以是配置通过字段对话框 ([单击以查看实际尺寸的图像](role-based-authorization-cs/_static/image18.png))
...
**图 8**： 管理登录视图的特定于角色的模板通过 RoleGroup 集合编辑器 ([单击以查看实际尺寸的图像](role-based-authorization-cs/_static/image24.png))
...
**图 9**: Bruce 显示在监督器特定于角色的消息 ([单击以查看实际尺寸的图像](role-based-authorization-cs/_static/image27.png))
...
**图 11**： 用于确定什么模板呈现 LoginView 控件的工作流 ([单击以查看实际尺寸的图像](role-based-authorization-cs/_static/image33.png))
...
**图 12**： 将转换 TemplateField CommandField 到 ([单击以查看实际尺寸的图像](role-based-authorization-cs/_static/image36.png))
...
**图 13**: 编辑和删除按钮处于隐藏状态为非监督和非管理员 ([单击以查看实际尺寸的图像](role-based-authorization-cs/_static/image39.png))
...
**图 14**： 虽然的编辑按钮，可用于在监督器中，删除按钮处于隐藏状态 ([单击以查看实际尺寸的图像](role-based-authorization-cs/_static/image42.png))
...
**图 15**: 编辑和删除按钮仅可为管理员 ([单击以查看实际尺寸的图像](role-based-authorization-cs/_static/image45.png))
