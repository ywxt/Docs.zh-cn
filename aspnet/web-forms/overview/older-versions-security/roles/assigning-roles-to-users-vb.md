...
**图 2**: 页上显示的用户和角色 ([单击以查看实际尺寸的图像](assigning-roles-to-users-vb/_static/image6.png))
...
**图 4**: Bruce 已添加到主管角色 ([单击以查看实际尺寸的图像](assigning-roles-to-users-vb/_static/image12.png))
...
**图 6**: GridView 列出了这些用户的属于所选角色 ([单击以查看实际尺寸的图像](assigning-roles-to-users-vb/_static/image18.png))
...
**图 8**： 唉，Tito 不再负责管理 ([单击以查看实际尺寸的图像](assigning-roles-to-users-vb/_static/image24.png))
...
**图 9**： 不能将非存在的用户添加到角色 ([单击以查看实际尺寸的图像](assigning-roles-to-users-vb/_static/image27.png))
...
**图 13**： 使 Wanda 在监督器角色的成员 ([单击以查看实际尺寸的图像](assigning-roles-to-users-vb/_static/image39.png))
...
**图 14**: Bruce、 Tito 和 Wanda 是所有监督器 ([单击以查看实际尺寸的图像](assigning-roles-to-users-vb/_static/image42.png))
