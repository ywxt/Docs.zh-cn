...
**图 1**： 添加新的 SQL 数据库命名`SecurityTutorials.mdf`数据库复制到`App_Data`文件夹 ([单击以查看实际尺寸的图像](creating-the-membership-schema-in-sql-server-cs/_static/image3.png))
...
**图 4**： 将附加`SecurityTutorials.mdf`数据库 ([单击以查看实际尺寸的图像](creating-the-membership-schema-in-sql-server-cs/_static/image12.png))
...
**图 5**:`SecurityTutorials.mdf`数据库会显示在数据库文件夹 ([单击以查看实际尺寸的图像](creating-the-membership-schema-in-sql-server-cs/_static/image15.png))
...
**图 7**： 使用 ASP.NET SQL Server 安装程序向导生成要添加的成员身份架构 ([单击以查看实际尺寸的图像](creating-the-membership-schema-in-sql-server-cs/_static/image21.png))
...
**图 10**: 不同的表、 视图和存储过程已添加到数据库 ([单击以查看实际尺寸的图像](creating-the-membership-schema-in-sql-server-cs/_static/image30.png))
...
**图 11**： 用户帐户可能会将分区跨多个应用程序 ([单击以查看实际尺寸的图像](creating-the-membership-schema-in-sql-server-cs/_static/image33.png))
