...
**图 1**: `RequiresQuestionAndAnswer`， `EnablePasswordRetrieval`，和`EnablePasswordReset`影响 PasswordRecovery 控件的外观和行为 ([单击以查看实际尺寸的图像](recovering-and-changing-passwords-vb/_static/image3.png))
...
**图 2**： 如果输入无效的用户名，则会显示错误消息 ([单击以查看实际尺寸的图像](recovering-and-changing-passwords-vb/_static/image6.png))
...
**图 3**： 如果用户输入无效的安全提示问题答案，会显示错误消息 ([单击以查看实际尺寸的图像](recovering-and-changing-passwords-vb/_static/image9.png))
...
**图 4**： 向用户发送一封电子邮件使用 His 的新密码 ([单击以查看实际尺寸的图像](recovering-and-changing-passwords-vb/_static/image12.png))
...
**图 5**: 主题、 正文和抄送已更新列表 ([单击以查看实际尺寸的图像](recovering-and-changing-passwords-vb/_static/image15.png))
...
**图 6**： 将 ChangePassword 控件添加到页 ([单击以查看实际尺寸的图像](recovering-and-changing-passwords-vb/_static/image18.png))
...
**图 7**： 将 ChangePassword 控件添加到页 ([单击以查看实际尺寸的图像](recovering-and-changing-passwords-vb/_static/image21.png))
...
**图 8**: 电子邮件消息通知用户，他们的密码已更改 ([单击以查看实际尺寸的图像](recovering-and-changing-passwords-vb/_static/image24.png))
...
**图 9**: 管理员可更改用户的密码 ([单击以查看实际尺寸的图像](recovering-and-changing-passwords-vb/_static/image27.png))
