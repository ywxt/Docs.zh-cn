...
**图 3**: Chris 已被未批准 ([单击以查看实际尺寸的图像](unlocking-and-approving-user-accounts-cs/_static/image9.png))
...
**图 4**: Chris 不能登录因为 His 帐户是否未批准 ([单击以查看实际尺寸的图像](unlocking-and-approving-user-accounts-cs/_static/image12.png))
...
**图 5**: Dave 具有已锁定的系统 ([单击以查看实际尺寸的图像](unlocking-and-approving-user-accounts-cs/_static/image15.png))
...
**图 6**： 新的用户会收到包含验证 URL 的链接的电子邮件 ([单击以查看实际尺寸的图像](unlocking-and-approving-user-accounts-cs/_static/image18.png))
...
**图 7**: 新用户的帐户是现在批准 ([单击以查看实际尺寸的图像](unlocking-and-approving-user-accounts-cs/_static/image21.png))
