...
若要从通过发送一封电子邮件，配置其`MailDefinition`属性正确。 中所述<a id="Tutorial13"> </a>[以前一教程](recovering-and-changing-passwords-vb.md)，ChangePassword 和取回控件包括[`MailDefinition`属性](https://msdn.microsoft.com/library/system.web.ui.webcontrols.createuserwizard.maildefinition.aspx)相同方式与的方式通过的。
