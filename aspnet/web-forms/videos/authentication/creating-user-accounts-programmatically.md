...
在此视频中，Joe stagner 将演示如何创建自定义在不使用创建用户向导时以编程方式创建用户 web 窗体。 有关本视频中的其他信息，请阅读"创建用户帐户"安全教程 ([C#](../../overview/older-versions-security/membership/creating-user-accounts-cs.md)， [VB](../../overview/older-versions-security/membership/creating-user-accounts-vb.md))。
