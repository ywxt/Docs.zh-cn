...
Joe stagner 将使用前面的代码示例来继续通过重定位和重命名的 ASP.NET 应用程序的登录功能自定义 ASP.NET 身份验证。 对于本演示的详细信息，本教程是所在[此处](../../overview/older-versions-security/introduction/forms-authentication-configuration-and-advanced-topics-vb.md)。
