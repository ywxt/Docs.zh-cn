...
---
<a name="how-do-i-linq-to-sql-overview"></a>[如何:]LINQ to SQL： 概述
====================
通过[Scott Stanfield](https://github.com/scottstanfield)

C# 和 VB 的新语言功能而无需编写 SQL 支持直接从代码中，数据访问。 此视频展示的最小的步骤，以使用 LINQ （语言集成查询） 来查询、 更新、 添加和从 Northwind 数据库中删除行。

[&#9654;观看视频 （9 分钟）](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/how-do-i-linq-to-sql-overview)

> [!div class="step-by-step"]
> [下一篇](how-do-i-linq-to-sql-data-model.md)
