...
以下代码所示**AuthenticateAsync**方法从[基本身份验证](http://aspnet.codeplex.com/sourcecontrol/latest#Samples/WebApi/BasicAuthentication/ReadMe.txt)示例。 注释中描述的每个步骤。 代码显示了几种类型的错误： 没有凭据，格式不正确的凭据和用户名/密码不正确的授权标头。
