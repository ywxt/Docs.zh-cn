...
ms.locfileid: "30071228"
---
<a name="jquery-datatables-191"></a><span data-ttu-id="c79d7-102">jQuery 数据表 1.9.1</span><span class="sxs-lookup"><span data-stu-id="c79d7-102">jQuery DataTables 1.9.1</span></span>
====================
<span data-ttu-id="c79d7-103">在 CDN 上托管 jQuery 数据表插件的以下文件：</span><span class="sxs-lookup"><span data-stu-id="c79d7-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
