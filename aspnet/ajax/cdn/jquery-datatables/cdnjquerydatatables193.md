...
---
<a name="jquery-datatables-193"></a><span data-ttu-id="54f00-102">jQuery 数据表 1.9.3 放置</span><span class="sxs-lookup"><span data-stu-id="54f00-102">jQuery DataTables 1.9.3</span></span>
====================
<span data-ttu-id="54f00-103">在 CDN 上托管 jQuery 数据表插件的以下文件：</span><span class="sxs-lookup"><span data-stu-id="54f00-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
