...
ms.locfileid: "30078304"
---
<a name="jquery-datatables-182"></a><span data-ttu-id="c8a8f-102">jQuery 数据表 1.8.2</span><span class="sxs-lookup"><span data-stu-id="c8a8f-102">jQuery DataTables 1.8.2</span></span>
====================
<span data-ttu-id="c8a8f-103">在 CDN 上托管 jQuery 数据表插件的以下文件：</span><span class="sxs-lookup"><span data-stu-id="c8a8f-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
