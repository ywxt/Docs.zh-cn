...
ms.locfileid: "37802164"
---
<a name="aspnet-web-forms-and-ajax-451"></a><span data-ttu-id="64a24-102">ASP.NET Web 窗体和 Ajax 4.5.1</span><span class="sxs-lookup"><span data-stu-id="64a24-102">ASP.NET Web Forms and Ajax 4.5.1</span></span>
====================
<span data-ttu-id="64a24-103">在 CDN 上托管的以下文件：</span><span class="sxs-lookup"><span data-stu-id="64a24-103">The following files are hosted on the CDN:</span></span>
...
<span data-ttu-id="64a24-104">注意： 全球化脚本，如 fr FR.js，可以在以下文件夹中找到：</span><span class="sxs-lookup"><span data-stu-id="64a24-104">Note: The globalization scripts, such as fr-FR.js, can be found in the following folder:</span></span>
