...
====================
<span data-ttu-id="77b6f-103">JQuery 模板插件包括以下文件：</span><span class="sxs-lookup"><span data-stu-id="77b6f-103">The jQuery Templates plugin includes the following files:</span></span>
