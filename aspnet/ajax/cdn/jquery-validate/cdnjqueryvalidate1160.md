...
---
<a name="jquery-validation-1160"></a><span data-ttu-id="f723d-102">jQuery 验证 1.16.0</span><span class="sxs-lookup"><span data-stu-id="f723d-102">jQuery Validation 1.16.0</span></span>
====================
<span data-ttu-id="f723d-103">在 CDN 上托管的以下文件：</span><span class="sxs-lookup"><span data-stu-id="f723d-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="f723d-104">本地化文件https://ajax.aspnetcdn.com/ajax/jquery.validate/1.16.0/localization/messages\_##.js其中 # # 是本地化代码。</span><span class="sxs-lookup"><span data-stu-id="f723d-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.16.0/localization/messages\_##.js where ## is the loc code.</span></span>
