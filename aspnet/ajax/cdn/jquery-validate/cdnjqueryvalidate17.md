...
ms.locfileid: "30077438"
---
<a name="jqueryvalidate-version-17"></a><span data-ttu-id="1df79-102">jquery.validate 版本 1.7</span><span class="sxs-lookup"><span data-stu-id="1df79-102">jquery.validate version 1.7</span></span>
====================
<span data-ttu-id="1df79-103">在 CDN 上托管以下文件：</span><span class="sxs-lookup"><span data-stu-id="1df79-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="1df79-104">本地化文件</span><span class="sxs-lookup"><span data-stu-id="1df79-104">Localization Files</span></span>
