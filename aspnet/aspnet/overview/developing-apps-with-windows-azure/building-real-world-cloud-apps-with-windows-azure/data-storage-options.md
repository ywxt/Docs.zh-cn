...
- [BASE: Acid 替代](http://queue.acm.org/detail.cfm?id=1394128)。 有关数据的一致性和可伸缩性方面做出权衡的文章。
- [这七个星期中的七个数据库： 现代数据库和 NoSQL 运动指南](https://www.amazon.com/Seven-Databases-Weeks-Modern-Movement/dp/1934356921)。 本书由 Eric 雷德蒙德和 Jim R.Wilson。 强烈建议引入自己的当前可用的数据存储平台范围的。
