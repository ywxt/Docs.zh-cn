...
====================
> Web Matrix 和 ASP.NET Web Pages (Razor) Beta 3 版本自述文件
...
#### <a name="issue-cannot-install-webmatrix-beta-3-if-microsoft-visual-studio-2008-is-installed-without-microsoft-visual-studio-2008-sp1"></a>如果没有 Microsoft Visual Studio 2008 SP1 的情况下安装 Microsoft Visual Studio 2008，问题： 不能安装 WebMatrix Beta 3
...
#### <a name="new-htmlraw-method-renders-unencoded-markup"></a>新增内容:"Html.Raw"方法将呈现未编码的标记
...
#### <a name="change-membership-role-and-security-types-moves-to-new-assembly"></a>更改： 成员身份、 角色和安全类型移动到新的程序集
...
#### <a name="change-tagbuilder-class-moved-to-systemwebwebpagesdll-assembly"></a>移动到 System.Web.WebPages.dll 程序集中的更改:"TagBuilder"类
...
#### <a name="issue-database-and-webgrid-helpers-do-not-work-in-medium-trust-in-visual-basic"></a>问题： 在中等信任在 Visual Basic 中无法工作数据库和 WebGrid 帮助器
...
#### <a name="issue-encrypt-property-is-not-recognized"></a>问题： 无法识别"Encrypt"属性
...
#### <a name="issue-microsoft-visual-c-2008-runtime-libraries-are-required"></a>Microsoft Visual c + + 2008年运行时库是必需的问题：
...
#### <a name="issue-wcf-applications-fail-to-run-with-iis-express"></a>问题： 无法使用 IIS Express 运行 WCF 应用程序
