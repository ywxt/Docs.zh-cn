...
## <a name="changes-and-issues"></a><span data-ttu-id="ca1d1-130">更改和问题</span><span class="sxs-lookup"><span data-stu-id="ca1d1-130">Changes and Issues</span></span>
...
> <span data-ttu-id="ca1d1-145">**Workaround**</span><span class="sxs-lookup"><span data-stu-id="ca1d1-145">**Workaround**</span></span>  
...
> <span data-ttu-id="ca1d1-158">卸载 SQL Server Compact 使用命令行选项不在此版本中无效。</span><span class="sxs-lookup"><span data-stu-id="ca1d1-158">Uninstallation of SQL Server Compact using command-line options does not work in this release.</span></span>
> 
...
> 2. <span data-ttu-id="ca1d1-211">删除*packages.config*在网站的根目录中的文件。</span><span class="sxs-lookup"><span data-stu-id="ca1d1-211">Delete the *packages.config* file in the root of the website.</span></span>
...
>         <span data-ttu-id="ca1d1-249">**to** *\Bin*</span><span class="sxs-lookup"><span data-stu-id="ca1d1-249">**to** *\Bin*</span></span>
...
> <span data-ttu-id="ca1d1-262">如果程序集包含派生自的对象`ApplicationPart`类，程序集的资源公开的`ResourceRouteHandler`类。</span><span class="sxs-lookup"><span data-stu-id="ca1d1-262">If an assembly contains objects that derives from the `ApplicationPart` class, that assembly's resources are exposed by the `ResourceRouteHandler` class.</span></span> <span data-ttu-id="ca1d1-263">例如，考虑以下 URL:</span><span class="sxs-lookup"><span data-stu-id="ca1d1-263">For example, consider the following URL:</span></span>  
>   
...
> 6. <span data-ttu-id="ca1d1-279">单击**数据库**和刷新。</span><span class="sxs-lookup"><span data-stu-id="ca1d1-279">Click **Databases** and refresh.</span></span>
...
> - <span data-ttu-id="ca1d1-297">在 Windows XP 中，将用户添加到管理员安全组。</span><span class="sxs-lookup"><span data-stu-id="ca1d1-297">On Windows XP, add the user to the Administrators security group.</span></span>
...
[<span data-ttu-id="ca1d1-340">https://go.microsoft.com/fwlink/?LinkID=208545</span><span class="sxs-lookup"><span data-stu-id="ca1d1-340">https://go.microsoft.com/fwlink/?LinkID=208545</span></span>](https://go.microsoft.com/fwlink/?LinkID=208545&amp;clcid=0x409)
...
> 3. <span data-ttu-id="ca1d1-355">应用将权限设置为 SQL Server Compact 通过将以下元素放入*Web\_MediumTrust.config*文件：</span><span class="sxs-lookup"><span data-stu-id="ca1d1-355">Apply the permission set to SQL Server Compact by putting the following elements in the *Web\_MediumTrust.config* file:</span></span>
> 
...
> 5. <span data-ttu-id="ca1d1-371">单击**清除日志**按钮。</span><span class="sxs-lookup"><span data-stu-id="ca1d1-371">Click the **Clear Log** button.</span></span>
...
> <span data-ttu-id="ca1d1-396">如果发布或下载 DotNetNuke 站点时，你可能需要清除缓存以获取要在站点上显示的新链接。</span><span class="sxs-lookup"><span data-stu-id="ca1d1-396">If you publish or download a DotNetNuke site, you might need to clear the cache to get the new links to appear on the site.</span></span>
> 
...
#### <a name="issue-mysql-based-applications-like-wordpress-fail-to-publish-and-report-a-database-error"></a><span data-ttu-id="ca1d1-406">问题： WordPress 等基于 MySQL 的应用程序不能发布，并将数据库错误报告</span><span class="sxs-lookup"><span data-stu-id="ca1d1-406">Issue: MySQL-based applications like WordPress fail to publish and report a database error</span></span>

> <span data-ttu-id="ca1d1-407">默认情况下，WebMatrix utf-8 字符集安装 MySQL。</span><span class="sxs-lookup"><span data-stu-id="ca1d1-407">By default, WebMatrix installs MySQL with the UTF-8 character set.</span></span> <span data-ttu-id="ca1d1-408">如果你将 MySQL 安装在你自己和设置的字符不是 utf-8 （例如，它是 Latin1），数据库的发布过程可能会失败。</span><span class="sxs-lookup"><span data-stu-id="ca1d1-408">If you install MySQL on your own, and the character set is not UTF-8 (for example, it is Latin1), the publish process for databases might fail.</span></span>
> 
> <span data-ttu-id="ca1d1-409">**Workaround**</span><span class="sxs-lookup"><span data-stu-id="ca1d1-409">**Workaround**</span></span>
> 
> 1. <span data-ttu-id="ca1d1-410">更改为 utf-8 的 MySQL 的字符集。</span><span class="sxs-lookup"><span data-stu-id="ca1d1-410">Change the character set for MySQL to UTF-8.</span></span> <span data-ttu-id="ca1d1-411">(有关详细信息，请参阅[服务器字符集和排序规则](http://dev.mysql.com/doc/refman/5.0/en/charset-server.html)MySQL 网站上。)</span><span class="sxs-lookup"><span data-stu-id="ca1d1-411">(For details, see [Server Character Set and Collation](http://dev.mysql.com/doc/refman/5.0/en/charset-server.html) on the MySQL website.)</span></span>
> 2. <span data-ttu-id="ca1d1-412">重新安装应用程序。</span><span class="sxs-lookup"><span data-stu-id="ca1d1-412">Reinstall the application.</span></span>
> 3. <span data-ttu-id="ca1d1-413">重新发布应用程序。</span><span class="sxs-lookup"><span data-stu-id="ca1d1-413">Republish the application.</span></span>


#### <a name="issue-download-published-site-fails-for-applications-that-have-browser-based-setup"></a><span data-ttu-id="ca1d1-414">问题:"下载发布站点"具有基于浏览器的安装程序的应用程序失败</span><span class="sxs-lookup"><span data-stu-id="ca1d1-414">Issue: "Download published site" fails for applications that have browser-based setup</span></span>

> <span data-ttu-id="ca1d1-415">某些应用程序 (例如，Kentico CMS) 要求你在浏览器中启动它们以执行安装后安装程序，如创建数据库。</span><span class="sxs-lookup"><span data-stu-id="ca1d1-415">Some applications (for example, Kentico CMS) require you to launch them in the browser in order to perform post-installation setup such as creating a database.</span></span> <span data-ttu-id="ca1d1-416">如果你发布此类应用程序，而不完成基于浏览器的安装程序，尝试从远程服务器下载相同的站点将失败。</span><span class="sxs-lookup"><span data-stu-id="ca1d1-416">If you publish an application like this without completing the browser-based setup, attempting to download the same site from a remote server will fail.</span></span>
> 
> <span data-ttu-id="ca1d1-417">**Workaround**</span><span class="sxs-lookup"><span data-stu-id="ca1d1-417">**Workaround**</span></span>  
> <span data-ttu-id="ca1d1-418">在将站点发布之前完成基于浏览器的设置。</span><span class="sxs-lookup"><span data-stu-id="ca1d1-418">Finish browser-based setup before publishing the site.</span></span>


#### <a name="issue-download-published-site-fails-with-a-database-error-for-dotnetnuke-and-kooboo-cms"></a><span data-ttu-id="ca1d1-419">问题:"下载发布站点"失败，出现数据库错误 DotNetNuke 和 Kooboo CMS</span><span class="sxs-lookup"><span data-stu-id="ca1d1-419">Issue: "Download published site" fails with a database error for DotNetNuke and Kooboo CMS</span></span>

> <span data-ttu-id="ca1d1-420">如果你尝试从服务器下载的应用程序，您必须在数据库连接字符串中的管理员凭据**发布设置**对话框中，你可能会看到发布日志中的以下错误：</span><span class="sxs-lookup"><span data-stu-id="ca1d1-420">If you try to download an application from a server and you have administrator credentials in the database connection string in the **Publish Settings** dialog, you might see the following error in the publish log:</span></span>
> 
> [!code-console[Main](overview/samples/sample9.cmd)]
> 
> <span data-ttu-id="ca1d1-421">**Workaround**</span><span class="sxs-lookup"><span data-stu-id="ca1d1-421">**Workaround**</span></span>  
> <span data-ttu-id="ca1d1-422">如果可行，重新发布该网站 （或将其发布） 的数据库使用非管理员凭据。</span><span class="sxs-lookup"><span data-stu-id="ca1d1-422">If practical, republish the site (or have it published) using non-administrator credentials for the database.</span></span>


<a id="More_Info"></a>

## <a name="for-more-information"></a><span data-ttu-id="ca1d1-423">更多信息</span><span class="sxs-lookup"><span data-stu-id="ca1d1-423">For More Information</span></span>

<span data-ttu-id="ca1d1-424">有关 WebMatrix 1.0 的详细信息，请参阅以下网站：</span><span class="sxs-lookup"><span data-stu-id="ca1d1-424">For more information about WebMatrix 1.0, see the following websites:</span></span>

- [<span data-ttu-id="ca1d1-425">IIS.net</span><span class="sxs-lookup"><span data-stu-id="ca1d1-425">IIS.net</span></span>](http://iis.net/)
- [<span data-ttu-id="ca1d1-426">ASP.NET 2.0</span><span class="sxs-lookup"><span data-stu-id="ca1d1-426">ASP.NET</span></span>](https://asp.net/webmatrix)
- [<span data-ttu-id="ca1d1-427">Microsoft.com/web</span><span class="sxs-lookup"><span data-stu-id="ca1d1-427">Microsoft.com/web</span></span>](https://www.microsoft.com/web)

<span data-ttu-id="ca1d1-428">© 2011 Microsoft Corporation.</span><span class="sxs-lookup"><span data-stu-id="ca1d1-428">© 2011 Microsoft Corporation.</span></span> <span data-ttu-id="ca1d1-429">保留所有权利。</span><span class="sxs-lookup"><span data-stu-id="ca1d1-429">All Rights Reserved.</span></span> <span data-ttu-id="ca1d1-430">[使用条款](https://msdn.microsoft.cos/cc300389.aspx)。</span><span class="sxs-lookup"><span data-stu-id="ca1d1-430">[Terms of Use](https://msdn.microsoft.cos/cc300389.aspx).</span></span>
