...
当用户导航到你的网站的基址时，向用户显示你的站点的默认页。 例如，当 Default.htm 作为该站点的默认页设置为 www.contoso.com，然后导航到<strong>(www.contoso.com)[www.contoso.com]</strong>导航到相同<strong>www.contoso.com/Default.htm</strong>。
