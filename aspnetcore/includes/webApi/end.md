## <a name="implement-the-other-crud-operations"></a><span data-ttu-id="ffe4d-101">实现其他的 CRUD 操作</span><span class="sxs-lookup"><span data-stu-id="ffe4d-101">Implement the other CRUD operations</span></span>
