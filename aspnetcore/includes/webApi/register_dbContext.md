## <a name="register-the-database-context"></a><span data-ttu-id="540fd-101">注册数据库上下文</span><span class="sxs-lookup"><span data-stu-id="540fd-101">Register the database context</span></span>
