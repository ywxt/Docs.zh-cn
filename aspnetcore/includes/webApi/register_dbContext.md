## <a name="register-the-database-context"></a><span data-ttu-id="0e064-101">注册数据库上下文</span><span class="sxs-lookup"><span data-stu-id="0e064-101">Register the database context</span></span>
