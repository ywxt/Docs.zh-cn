# <a name="custom-webhost-service-sample"></a><span data-ttu-id="1155a-101">自定义 WebHost 服务示例</span><span class="sxs-lookup"><span data-stu-id="1155a-101">Custom WebHost Service Sample</span></span>
