# <a name="aspnet-core-url-rewriting-sample-aspnet-core-1x"></a>ASP.NET Core URL 重写示例 (ASP.NET Core 1.x)

本示例演示 ASP.NET Core 1.x URL 重写中间件的用法。 该应用程序演示 URL 重定向和 URL 重写选项。 有关 ASP.NET Core 2.x 示例，请参阅 [ASP.NET Core URL 重写示例 (ASP.NET Core 2.x)](https://github.com/aspnet/Docs/tree/master/aspnetcore/fundamentals/url-rewriting/samples/2.x)。
