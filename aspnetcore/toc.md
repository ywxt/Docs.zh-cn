...
### [在 Mac 或 Linux 上使用 Visual Studio Code 创建 Web 应用](xref:tutorials/first-mvc-app-xplat/index)
...
### [为本机移动应用创建后端服务](mobile/native-mobile-backend.md)
...
##### [分布式缓存标记帮助程序](mvc/views/tag-helpers/built-in/distributed-cache-tag-helper.md)
...
### [使用应用模型](mvc/controllers/application-model.md)
...
## [使用 IHostingStartup 从外部程序集添加应用功能](xref:host-and-deploy/ihostingstartup)
