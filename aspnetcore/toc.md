...
## [创建 Web 应用](xref:razor-pages/index)
...
### [在 Visual Studio for Windows 中创建 Web API](xref:tutorials/first-web-api)
...
## [静态文件](fundamentals/static-files.md)
...
## [会话和应用状态](fundamentals/app-state.md)
...
## [在 .NET Core 和 .NET Framework 之间进行选择](/dotnet/articles/standard/choosing-core-framework-server)
## [在 ASP.NET Core 和 ASP.NET 之间进行选择](xref:fundamentals/choose-between-aspnet-and-aspnetcore)

# [Razor 页面](xref:razor-pages/index)
...
#### [内置标记帮助程序](xref:mvc/views/tag-helpers/builtin-th/Index)
