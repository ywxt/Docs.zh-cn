...
ms.locfileid: "36279085"
---
[!INCLUDE [adding-model](../../includes/mvc-intro/sql.md)]

> [!div class="step-by-step"]
> <span data-ttu-id="e7d9e-103">[上一篇 - 添加模型](adding-model.md)
> [下一篇 - 控制器方法和视图](controller-methods-views.md)</span><span class="sxs-lookup"><span data-stu-id="e7d9e-103">[Previous - Add a model](adding-model.md)
