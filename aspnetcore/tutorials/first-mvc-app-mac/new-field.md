...
> <span data-ttu-id="fb7ff-103">[上一篇 - 添加搜索](search.md)
> [下一篇 - 添加验证](validation.md)</span><span class="sxs-lookup"><span data-stu-id="fb7ff-103">[Previous - Add search](search.md)
