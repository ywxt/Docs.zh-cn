...
ms.locfileid: "36274549"
---
[!INCLUDE [SQLlite](../../includes/RP/sql.md)]

> [!div class="step-by-step"]
> <span data-ttu-id="46a29-103">[上一篇：添加模型](xref:tutorials/razor-pages-mac/model)
> [下一篇：更新页面](xref:tutorials/razor-pages-mac/da1)</span><span class="sxs-lookup"><span data-stu-id="46a29-103">[Previous: Adding a model](xref:tutorials/razor-pages-mac/model)
