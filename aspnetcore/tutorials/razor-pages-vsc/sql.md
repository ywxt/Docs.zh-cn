...
<span data-ttu-id="87a4d-103">[上一篇：添加模型](xref:tutorials/razor-pages-vsc/model)
[下一篇：更新页面](xref:tutorials/razor-pages-vsc/da1)</span><span class="sxs-lookup"><span data-stu-id="87a4d-103">[Previous: Adding a model](xref:tutorials/razor-pages-vsc/model)
