...
ms.locfileid: "38185171"
---
[!INCLUDE [SQLlite](../../includes/RP/sql.md)]

> [!div class="step-by-step"]
> <span data-ttu-id="5a4e9-103">[上一篇：添加模型](xref:tutorials/razor-pages-vsc/model)
> [下一篇：更新页面](xref:tutorials/razor-pages-vsc/da1)</span><span class="sxs-lookup"><span data-stu-id="5a4e9-103">[Previous: Adding a model](xref:tutorials/razor-pages-vsc/model)
