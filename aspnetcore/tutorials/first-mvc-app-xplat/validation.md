...
ms.locfileid: "30897141"
---
[!INCLUDE [validation](../../includes/mvc-intro/validation.md)]

> [!div class="step-by-step"]
> <span data-ttu-id="c8454-103">[上一篇 - 添加字段](new-field.md)
> [下一篇 - 检查详细信息和删除方法](xref:tutorials/first-mvc-app/details)</span><span class="sxs-lookup"><span data-stu-id="c8454-103">[Previous - Add a field](new-field.md)
